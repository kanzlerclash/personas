...
let dateien = 0, scoreFix = 0, seiteFix = 0, rest = 0;
...
console.log(`${PARTEI}: ${dateien} Dateien · ${scoreFix} Score korrigiert · ${seiteFix} Seiten korrigiert · ${rest} Zitate weiter ungeprüft`);
