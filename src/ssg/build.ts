...
<p class="mini"><strong>Zur Spalte „Stand":</strong> Angegeben ist das von der Partei genannte Beschluss- bzw. Stand-Datum. Zur Plausibilität haben wir es gegen das Erstellungsdatum in den PDF-Metadaten (<code>CreationDate</code>) gehalten — die PDFs wurden jeweils am oder kurz nach dem Beschluss erzeugt. Die AfD-Fassung liegt nur als HTML ohne verlässliches Dokumentdatum vor; dort nennen wir das Abrufdatum.</p>
